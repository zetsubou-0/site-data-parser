...
public enum CharacteristicsType {
    ...
    CHANNEL("Каналы управления", "T_59"),
    ZONE("Зоны управления", "T_68"),
    CONTROL_CONNECTION_TYPE("Связь пульт/контроллер", "T_61"),
    CONTROL_INTERACTION_TYPE("Свойства пульта/панели", "T_81"),
    FREQUENCY("Частота передачи данных, MHz", "T_112"),
    MOUNTING_METHOD("Способ монтажа", "T_51"),
    FUNCTION("Назначение", "T_53"),
    SERIES("Серия", "T_96"),
    PRODUCT_TYPE("Тип товара", "T_62"),
    COLOR("Цвет покрытия", "T_58"),
    ...
    AREA_WIDTH("Ширина площадки", "T_52"),
    LIGHTS_LINE_WIDTH("Ширина световой линии, мм", "T_146"),
    SIZE_THREE_D("Габариты", "T_22"),
